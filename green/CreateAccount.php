...
<title>申請帳號</title>
<body>
	<form name="form1" method="post" action="register.php" onclick="return false">
  <fieldset>
    <legend style="color: black; font-weight: bold;">建立帳號</legend>
    <div class="form-group">
      <label><span style="color: red;">*</span>帳號</label>
      <input type="text" class="form-control" id="Account" placeholder="輸入帳號" name="Account">
    </div>
    <div class="form-group">
      <label><span style="color: red;">*</span>信箱</label>
      <input type="text" class="form-control" id="Email" placeholder="輸入信箱" name="Email" onblur='isEmail(this.value)'>
    </div>
    <div class="form-group" name="psw">
      <label><span style="color: red;">*</span>密碼</label>
      <input type="password" class="form-control" id="Password" placeholder="至少8碼 至多15碼" name="Password" min="8" max="15" onblur='yanzheng(this.value)'>
    </div>
    <div class="form-group">
      <label><span style="color: red;">*</span>再次輸入密碼</label>
      <input type="password" class="form-control" id="PasswordAgain" placeholder="至少8碼 至多15碼" name="PasswordAgain" min="8" max="15" onblur='testpw()'>
    </div>
    <div class="form-group">
