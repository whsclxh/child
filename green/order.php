...
<div class="container" align="center" >
    ...
    <h5><span>購買日期:<?php echo "$payr[6]"; ?></span>&nbsp|&nbsp<span>支付方式:<?php echo "$payr[11]"; ?></span>&nbsp|&nbsp<span>訂單編號:<?php echo "$payr[5]"; ?></span>&nbsp|&nbsp<span>商品總額:<?php echo "$payr[12]"; ?></span></h5>
