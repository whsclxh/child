...
$check="SELECT * FROM shopping_cart where Account = '$Account'";
$result = mysqli_query($link,$check);
$checkr = @mysqli_fetch_row($result);
//使用者無購物車紀錄直接傳入資料庫
if($checkr==null){
	$cart="insert into shopping_cart (Account,Amount,
