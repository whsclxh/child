...
<script type="text/javascript" src="jquery-3.3.1.min.js"></script>
    ...
    <script type="text/javascript">
        function go(v){
            var a = document.getElementById("data");                                         //設置input value
            a.value = v;
    ...
    <script type="text/javascript">
        ...
        window.onload=function(){
            ...
            <?php for($x=$list[8];$x> 0;$x--){ ?>
            <?php
            $sql = "SELECT * FROM clock_score where username = '$id' AND cardinal = '$x'";
            $result = mysqli_query($qaq,$sql);
            $score_sql = @mysqli_fetch_row($result);
            ?>
            var trNode=tableNode.insertRow();
            var tdNode1=trNode.insertCell();
            tdNode1.innerHTML="時鐘";
            ...
            cell4.innerHTML = "<input type='hidden' name='data' id='cog_data'><b></b>";
