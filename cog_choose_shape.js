	...
	function cog_choose_shape_get(x){
		if(x==0){
	...
	function cog_choose_shape_insert_picture_1(x,y,z){
		if(x==0){
			var view=[
	...
	function cog_choose_shape_insert_picture_2(x,y,z){
		if(x==0){
			var view=[
			'img/shape/circle/circle1.png',
			'img/shape/circle/circle2.png',
	...
	function cog_choose_shape_insert_picture_3(x,y,z){
		if(x==0){
			var view=[
			'img/shape/circle/circle1.png',
			'img/shape/circle/circle2.png',
	...
	function cog_choose_shape_insert_picture_4(x,y,z){
		if(x==0){
			var view=[
			'img/shape/circle/circle1.png',
			'img/shape/circle/circle2.png',
