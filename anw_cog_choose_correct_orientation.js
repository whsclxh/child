function anw_cog_choose_correct_orientation_pictures(x){
		var imgurl=[
    	'img/animal/bear.png',
	...
	function anw_cog_choose_correct_orientation_set_question_name(x){
		var fruitsname=[
			'熊',
			'鱷魚',
			'大象',
	...
	function anw_cog_choose_correct_orientation_write_direction(x,y){
		if(x==0){
			var direction=[
			'下面',
			'右邊',];
