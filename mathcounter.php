...
if(mysqli_query($link,$math_sql)){
		if(mysqli_query($link,$math_choose_sql)&&mysqli_query($link,$add_sub_num_sql)&&mysqli_query($link,$math_big_small_sql)&&mysqli_query($link,$math_multistage_sql)&&mysqli_query($link,$math_triple_add_sql)){
